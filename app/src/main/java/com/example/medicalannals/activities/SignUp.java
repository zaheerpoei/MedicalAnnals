    ...
    private void clickListeners() {
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(rbDoctorSignUp.isChecked() == true){
                Intent i = new Intent(SignUp.this , DoctorDashboard.class);
                i.putExtra("PhoneNumber" , number);
                startActivity(i);
                }
                else if(rbPatientSignUp.isChecked() == true){
                Intent i = new Intent(SignUp.this , PatientDashboard.class);
                i.putExtra("PhoneNumber" , number);
                startActivity(i);
                }
